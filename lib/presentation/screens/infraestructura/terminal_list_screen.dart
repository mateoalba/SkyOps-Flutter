...
class _TerminalListScreenState extends State<TerminalListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<TerminalProvider>().cargar();
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final items = provider.items.where((item) {
      ...
      return item.nombre.toString().toLowerCase().contains(q) ||
          item.codigo.toString().toLowerCase().contains(q);
    }).toList();
    ...
    return Scaffold(
      ...
      body: LoadingOverlay(
        ...
        child: RefreshIndicator(
          onRefresh: () => context.read<TerminalProvider>().cargar(forzar: true),
          child: Column(
            children: [
              SearchField(
                hintText: 'Buscar terminal...',
                ...
                child: items.isEmpty
                    ? ListView(
                        children: [
                          ...
                          Center(
                            child: Text(
                              provider.estado == EstadoCargaTerminal.error
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return EntityListCard(
                            ...
                            onTap: puedeEscribir ? () => context.push('/terminales/${item.id}/editar') : null,
                          );
                        },
                      ),
              ),
