...
class _MantenimientoListScreenState extends State<MantenimientoListScreen> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      context.read<MantenimientoProvider>().cargar();
    });
  }
    ...
    return Scaffold(
      ...
      floatingActionButton: puedeEscribir
          ? FloatingActionButton(
              heroTag: 'mantenimientos_nuevo_fab',
      ...
      body: LoadingOverlay(
        ...
        child: RefreshIndicator(
          onRefresh: () => context.read<MantenimientoProvider>().cargar(forzar: true),
          child: Column(
            children: [
              SearchField(
                ...
                child: items.isEmpty
                    ? ListView(
                        children: [
                          ...
                          Center(
                            child: Text(
                              provider.estado == EstadoCargaMantenimiento.error
                    ...
                    : ListView.separated(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return EntityListCard(
                            ...
                            onTap: puedeEscribir ? () => context.push('/mantenimientos/${item.id}/editar') : null,
                          );
                        },
                      ),
              ),
